...
{
    PWSTR DebugLogFile = L"-";
    ULONG DebugFlags = -1;
    PWSTR VolumePrefix = 0;
    PWSTR PassThrough = L"/Programs/Fortnite/Fortnite";
    PWSTR MountPoint = L"C:/regfsRoot3";
    HANDLE DebugLogHandle = GetStdHandle(STD_ERROR_HANDLE);
    WCHAR PassThroughBuf[MAX_PATH];
    PTFS* Ptfs = 0;
    NTSTATUS Result;

    //EnableBackupRestorePrivileges(); does nothing?
