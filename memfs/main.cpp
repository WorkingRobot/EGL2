...
static UINT64 FileGetSize(PCWSTR fileName) {
...
NTSTATUS SvcStart(FSP_SERVICE* Service, ULONG argc, PWSTR* argv)
{
    ...
    MEMFS_FILE_PROVIDER* Provider = CreateProvider(FileOpen, FileClose, FileGetSize, FileRead);
